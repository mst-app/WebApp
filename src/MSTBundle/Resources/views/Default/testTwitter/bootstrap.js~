...
"1:51", "2:03", "2:17", "2:27", "2:33", "2:44","0",
 ...
 "6:13", "6:19", "6:24", "0", "0"];
   ...
   for (var i = 0; i < 2; i++)
   {  
      print += "<div class=\".col-xs-6 .col-md-4\"><h2 class=\"sub-header\">" + schedule[nb] + "</h2><div class=\"table-responsive\"><table class=\"table table-bordered\"><thead><tr>";
      nb++;
      while (schedule[nb] != "0")
      {
...
{   
    ...
    if ( Sta == "" || En == "")     
    { 
        //window.alert("empty " + Sta);
        return; 
    } 

    Sta = showId(document.getElementById('start').value);
    En = showId(document.getElementById('end').value);
    //window.alert(Sta + "  " + En);
...
function printRouteInfo(response)
{
    ...
    info2 = info2 + "<font color=\"#FF0000\">Arrival Time: " + route.arrival_time.text + "</font>";
    info2 = info2 + "</font> </p>";
...
{
    //window.alert(str);
    var stops = ["Monterey Transit Plaza", "Fisherman’s Wharf", "Lighthouse Ave.", "Monterey Bay Aquarium", "Downtown Pacific Grove",
 ...
 "0"
    ...
    var sIds = ["36.597310,-121.894246", "36.602915,-121.895327", "36.623142,-121.922532", "36.617447,-121.902694", "36.631707,-121.924908", "36.633404,-121.931951", "36.633420,-121.931955", "36.621181,-121.936038", "36.624752,-121.918811", "36.625078,-121.917289", "36.555141,-121.917723", "36.584754,-121.897238", "36.613170,-121.912001", "36.607362,-121.922474", "36.607957,-121.923265", "",""];
    if (str == "")
        return "";
    var i = 0;
    while (stops[i] != str && stops[i] != "0")
        i++;
    //window.alert(sIds[i]);
    if (stops[i] == "0")
        return "";
